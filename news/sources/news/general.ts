...
import log from "../../../utils/logging";
  ...
  class GeneralAsSource{
    private target: string = 'https://financialmodelingprep.com/api/v4/general_news';
    private apikey: string = env.FMP_API_KEY;
    constructor(public pageSize: number= 5, public maxPageNumber: number= 1){}

    /**
     * Asynchronously builds the news articles for the General source.
     *
    ...
    async build(): Promise<void>{
      ...
      try {
        ...
        log("error", "News > Gen.:: Error inserting articles to MongoDB or producing messages", error);
      }
    }
  }
  
export default GeneralAsSource; 
