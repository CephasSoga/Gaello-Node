...
import log from "../../../utils/logging";
  ...
  class PressAsSource{
    private target: string = 'https://financialmodelingprep.com/api/v3/press-releases';
    private apikey: string = env.FMP_API_KEY;
    constructor(public pageSize: number= 5,  public maxPageNumber: number= 1){}

/**
 * Asynchronously builds the news articles for the Press source.
 *
 * This function fetches paginated data from the Press API, processes the articles,
 ...
 */
    async build(): Promise<void>{
      ...
      try {
        ...
        log("error", "News > Press:: Error inserting articles to MongoDB or producing messages", error);
      }
    }
  }
  
export default PressAsSource;